...
### Funcionalidad		99.50%
	...
	Los errores (si los hay) se muestran con un mensaje en pantalla. 	90.00%
...
### Calidad de código		50.00%
	El README indica claramente como instalar el proyecto y setupear el linter	50.00%
	El linter Eslint no reporta errores de estilo	50.00%
### Uso de git		100.00%
...
# Comentarios		
	...
	- Muestren que tipo de error ocurre	
	- No muestran como configurar el linter en el README	
	- No instalaron el linter 	